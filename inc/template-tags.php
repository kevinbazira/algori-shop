...
if ( ! function_exists( 'algori_shop_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function algori_shop_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'algori-shop' ),
...
if ( ! function_exists( 'algori_shop_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function algori_shop_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'algori-shop' ),
